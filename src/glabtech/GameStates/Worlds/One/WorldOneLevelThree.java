...
public class WorldOneLevelThree extends GameState {

	public WorldOneLevelThree(GameStateManager gsm) {
		super(gsm);
	}
	...
	public void update() {
		...
		/*
		 * if (!player.hasEgg && egg.isItemGone()) { populateEgg(); }
		 */
